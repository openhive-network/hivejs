...
var _rpcAuth = require('@hivechain/rpc-auth');
...
var Hivejs = function (_EventEmitter) {
    _inherits(Hivejs, _EventEmitter);

    function Hivejs() {
        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

        _classCallCheck(this, Hivejs);

        var _this = _possibleConstructorReturn(this, (Hivejs.__proto__ || Object.getPrototypeOf(Hivejs)).call(this, options));
...
var hivejs = new Hivejs(_config2.default);
